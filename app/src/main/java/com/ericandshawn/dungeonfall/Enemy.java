...
public class Enemy extends AnimatedSprite {
    ...
    public Enemy(float pX, float pY, ITiledTextureRegion pTextureRegion, VertexBufferObjectManager vbom, PhysicsWorld pWorld, Scene scene, String userData, int scaleX, int scaleY, int frameRate)
    {
